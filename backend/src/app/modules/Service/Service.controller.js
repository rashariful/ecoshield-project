...
const getSingleServiceBySlug = catchAsync(async (req, res) => {
  const { slug } = req.params;
  const result = await ServiceServices.getSingleServiceBySlug(slug);
  ...
  sendResponse(res, {
    status: 200,
    success: true,
    message: "Single service fetched by slug successfully",
    data: result,
  });
});
